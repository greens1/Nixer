...
public class TechPage extends AppCompatActivity {

    //this page displays all tasks related to Technology
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<Task> listTasks = db.getListOfTasksByCategory("Technology");// get a list of tasks that have the category technology
        ...
        if (listTasks.size() != 0) {
            ...
            Toast.makeText(this, "There are no Nixers about Technology", Toast.LENGTH_LONG).show();
        }
    }
}

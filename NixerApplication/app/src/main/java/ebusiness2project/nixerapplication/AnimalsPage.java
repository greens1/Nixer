...
public class AnimalsPage extends AppCompatActivity {
    ...
    //this page displays all tasks related to Animals
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<Task> listTasks = db.getListOfTasksByCategory("Animals");// get a list of tasks that have the category Animals
        ...
        if (listTasks.size() != 0) {
            ...
            Toast.makeText(this, "There are no Nixers about Animals", Toast.LENGTH_LONG).show();
        }
    }
}